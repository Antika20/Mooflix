...
class MovieRepository(private val remoteDataSource: RemoteDataSource,private val dataStore: DataStore<Preferences>
) : MovieDataSource {
    ...
    companion object {
        ...
        fun getInstance(remoteDataSource: RemoteDataSource, dataStore: DataStore<Preferences>): MovieRepository =
